...
@Controller
public class aiparamsNew_202_controller {
    @Autowired
    ...
    @CrossOrigin
    @PostMapping("/getData/202/aiparams-1")
    @ResponseBody
//    @Scheduled(fixedRate = 30000)
    ...
    String restart="0";
    @CrossOrigin
    @PostMapping("/getData/202/aicontrol-1")
    @ResponseBody
//    @Scheduled(fixedRate = 30000)
