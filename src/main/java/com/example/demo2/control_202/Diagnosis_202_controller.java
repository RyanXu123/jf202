...
import java.util.*;
@Controller
public class Diagnosis_202_controller {
...
//    @Scheduled(fixedRate = 30000)
    ...
    @Autowired
    private com.example.demo2.mapper.logMapper logMapper;
    @CrossOrigin
...
//送风范围
        ...
        } else if (!sfRange.equals(sf_range)) {
        ...
        } else if (!hfRange.equals(hf_range)) {
        ...
        } else if (!ysjRange.equals(ysj_range)) {
        ...
        } else if (!fjRange.equals(fj_range)) {
        ...
        } else if (!lnfjRange.equals(lnfj_range)) {
...
//    @Scheduled(fixedRate = 30000)
    ...
    public JSONObject diagnosis_server_design2(@RequestBody JSONObject data){
        ...
        } else if (!coldRange.equals(cold_range)) {
        ...
        } else if (!hotRange.equals(hot_range)) {
