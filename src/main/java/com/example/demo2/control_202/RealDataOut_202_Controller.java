...
@Controller
public class RealDataOut_202_Controller {
    @Autowired
    ...
    public List<Map<String,Object>> dataout(@RequestBody List<String> data) {
        ...
        String sql_data = "  select * from realdata_once where Location='JF202' and Equipment='空调1' and PointName='送风温度1' ";//从表中筛选某空调的所有参数
