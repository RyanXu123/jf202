...
//    @Scheduled(fixedRate = 30000)
    public List<Map<String,Object>> getdata203_p(){
        ...
        String sql1="select * from realdata_once203 where Location='JF203' and Equipment='服务器' and SiteName='X1-上' ";
        String sql2="select * from realdata_once203 where Location='JF203' and Equipment='服务器' and SiteName='X1-下' ";
